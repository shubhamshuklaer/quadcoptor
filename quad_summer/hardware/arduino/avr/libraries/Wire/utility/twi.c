...
static volatile bool use_internal_pull_up;
 ...
 * Output   none
 */
void twi_init(bool _use_internal_pull_up)
{
  ...
  use_internal_pull_up=_use_internal_pull_up;
...
unsigned long wait_count=50000UL;
